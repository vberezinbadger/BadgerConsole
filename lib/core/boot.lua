...
_G._OSVERSION = "Badger Server 1.17.1.231_beta"
...
status("Booting Badger Server Beta...")
...
status("Initializing libraries and scripts...")
...
status("Initializing file system, checking disk...")

-- Mount the ROM and temporary file systems to allow working on the file
-- system module from this point on.
require("filesystem").mount(computer.getBootAddress(), "/")

status("Running bootloader...")
